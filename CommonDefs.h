...
#define GAIN_DERIVATIVE 0.265f   //Derivative gain of PID

#define GAIN_SCALE_DOWN 110.0f   //scales down every scaling value. Divided at the end of output calculation.
...
#define GAIN_P_WHEEL 22.5f
#define GAIN_I_WHEEL 0.15f

#define BASE_SPEED 1.10f         //m/s. Base speed at which the buggy runs. With current tuning, stable until ~1.1 m/s
