...
#define GUARD1_SCALING 5.0f     //Overall scaling for GUARD1 sensors (S5,S2)
#define GUARD2_SCALING 18.0f     //Overall scaling for GUARD2 sensors (S6,S1)

#define GAIN_P_WHEEL 60.0f
#define GAIN_I_WHEEL 0.05f

#define BASE_SPEED 1.2f         //m/s. Base speed at which the buggy runs. With current tuning, stable until ~1.1 m/s
