...
#define GAIN_INTEGRAL 0.30f     //Integral gain of PID
#define GAIN_DERIVATIVE 0.80f   //Derivative gain of PID

#define GAIN_SCALE_DOWN 150.0f  //scales down every scaling value. Divided at the end of output calculation.
...
#define BASE_SPEED 0.4f         //m/s. Base speed at which the buggy runs. With current tuning, stable until ~1.1 m/s
