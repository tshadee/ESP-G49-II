...
#define SENSOR_POLL_FREQ 500    //Hz , Ideally 5 times that of SYS_OUTPUT_RATE
...
#define S1_SCALE 1.42f

#define BASE_SPEED 0.3f         //m/s. Base speed at which the buggy runs. With current tuning, stable until ~1.1 m/s
...
#define SYS_OUTPUT_RATE 100     //Hz , Ideally 1/5 that of SENSOR_POLL_FREQ and no greater than 1000 Hz.
